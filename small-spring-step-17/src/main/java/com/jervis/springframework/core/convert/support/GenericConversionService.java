...
import com.jervis.springframework.core.convert.converter.GenericConverter;
...
public class GenericConversionService implements ConversionService, ConverterRegistry {
    ...
    GenericConverter.ConvertiblePair typeInfo = getRequiredTypeInfo(converter);
        GenericConversionService.ConverterAdapter converterAdapter = new GenericConversionService.ConverterAdapter(typeInfo, converter);
    ...
    public void addConverterFactory(ConverterFactory<?, ?> converterFactory) {
        ...
        GenericConversionService.ConverterFactoryAdapter converterFactoryAdapter = new GenericConversionService.ConverterFactoryAdapter(typeInfo, converterFactory);
