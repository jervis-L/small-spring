...
import com.jervis.springframework.beans.factory.*;
import com.jervis.springframework.beans.factory.config.*;
...
//        Object bean = null;
//        try {
        //不会再这里注册DefaultAdvisorAutoProxyCreator了
...
//                这个lambda表达式实现了ObjectFactory<？>唯一方法， getObject
    ...
    //这个应该就是判断接下来该类是否还需要利用BeanPostProcessors扩展，现阶段好像没太多用处
...
//    }
    ...
    private void invokeInitMethods(String beanName, Object bean, BeanDefinition beanDefinition) throws Exception {
        ...
        // 2. 注解配置 init-method {判断是为了避免二次执行初始化,应该实现了接口就不用xml的配置了}
